...
module SamlIdp
  class ResponseBuilder
    ...
    def initialize(response_id:, issuer_uri:, saml_acs_url:, saml_request_id:, assertion_and_signature:, raw_algorithm:, x509_certificate: nil, secret_key: nil, password: nil)
